...
const TAIWAN_BRAND_MATRIX = [
  {
    brand: "大金 Daikin",
    series: "橫綱Z / 橫綱Y 系列 (最新世代)",
    tech: "溫濕雙控 (Hybrid Cooling)、閃流放電主動除菌、19dB極低頻",
    bestFor: "淺眠怕吵臥室、極度重視恆溫與防濕黏",
    link: "/tools/ac-brand-matrix",
  },
  {
    brand: "國際牌 Panasonic",
    series: "VX極致旗艦 / UX / UJ 系列",
    tech: "離線智能聲控、nanoeX 48兆微粒子、全台最高 CSPF 7.42",
    bestFor: "重視省電電費、過敏兒家庭、全台維修叫修最快",
    link: "/tools/ac-brand-matrix",
  },
  {
    brand: "日立 Hitachi",
    series: "尊榮系列 (凍結洗淨 3.0+)",
    tech: "凍結洗淨 3.0⁺ (室內外機油污加熱軟化)、iWarm 智控暖房",
    bestFor: "長輩最信賴品牌、自動洗鰭片、全台據點多",
    link: "/tools/ac-brand-matrix",
  },
  {
    brand: "三菱重工 MHI",
    series: "晴空 (ZST2) / 朝日 (ZTLT2)",
    tech: "JET 航太噴射氣流長距送風 (17m)、壓縮機 15 年保固",
    bestFor: "客餐廳開放式大空間、狹長格局、追求極速冷房",
    link: "/tools/ac-brand-matrix",
  },
  {
    brand: "富士通 / 日本將軍",
    series: "nocria Z / nocria X 系列",
    tech: "全機 10 年保固 (業界領先)、自動清濾網機器人、0.5℃溫控",
    bestFor: "懶得手動洗濾網、極度重視全機保固年限者",
    link: "/tools/ac-brand-matrix",
  },
  {
    brand: "LG 台灣樂金",
    series: "DUALCOOL AI 2.0 系列",
    tech: "雙迴轉變頻壓縮機省電 70%、ThinQ App 智慧聯網、UVnano",
    bestFor: "智慧家庭愛好者、極簡美型裝潢、手機遠端遙控",
    link: "/tools/ac-brand-matrix",
  },
  {
    brand: "禾聯 Heran",
    series: "SL尊榮 (沼氣防護2.0) / HW窗型",
    tech: "沼氣防護 2.0 特殊抗腐蝕塗層、台灣窗型冷氣市佔第一",
    bestFor: "房東租屋套房、老屋窗型更換、預算導向拿滿補助",
    link: "/tools/ac-brand-matrix",
  },
  {
    brand: "東元 TECO",
    series: "HS8 頂級變頻 / MW窗型",
    tech: "重電工業級馬達耐操、燦金防鏽、CSPF 超一級能效",
    bestFor: "重視馬達耐用度、支持台灣老牌重電製造",
    link: "/tools/ac-brand-matrix",
  },
];
